...
//         int depth_align8 = conv_desc.group_indepth;
//         int width_align8 = conv_desc.inwidth_align8;
//         int height = conv_desc.inheight;
//         assert(depth_align8 %8 ==0);

//         int total_bytes = depth_align8*width_align8*height*2*sizeof(ap_int<ODDR_WIDTH>);
//         printf("bottom bytes [%d %d %d]\n",depth_align8,width_align8, height);
//         assert( total_bytes < FEATURE_PORT_DEPTH*16);
...
//         featuremap.buffers_hw.push_back(input_DDR);
//         featuremap.byte_size_hw=total_bytes;
//         featuremap.group_depth=conv_desc.group_indepth;
//     }
//     else
//     {
//         int depth_align8 = conv_desc.group_outdepth;
//         int width_align8 = conv_desc.outwidth_align8;
//         int height = conv_desc.outheight_align4;
//         assert(depth_align8 %8 ==0);
//         int total_bytes = depth_align8*width_align8*height*2*sizeof(ap_int<ODDR_WIDTH>);
//         printf("top bytes [%d %d %d]\n",depth_align8,width_align8, height);
...
//         char* output_DDR = (char*) MALLOC(FEATURE_PORT_DEPTH*16); //new char[height*width_align8*group_depth_by8*8*16];
//         memset(output_DDR,0xCD,total_bytes);
//         featuremap.buffers_hw.push_back(output_DDR);
//         featuremap.byte_size_hw=total_bytes;
//         featuremap.group_depth=conv_desc.group_outdepth;
//     }
...
//     int total_bytes=depth_align8*height_align8*width_align8*BATCH_SIZE;
//     assert( total_bytes < FEATURE_PORT_DEPTH*16);
//     char* DDR = (char*) MALLOC(FEATURE_PORT_DEPTH*16); //new char[height*width_align8*group_depth_by8*8*16];

//     featuremap.buffers_hw.push_back(DDR);
//     featuremap.byte_size_hw=total_bytes;
//     featuremap.group_depth=depth_align8;  //TODO: merge the group result when it is here. 

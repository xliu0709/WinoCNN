create_project RTL_ultra96 ./RTL_ultra96 -part xczu3eg-sbva484-1-e
...
set_property -dict [list CONFIG.PSU__USE__M_AXI_GP1 {0} CONFIG.PSU__USE__S_AXI_GP2 {1} CONFIG.PSU__USE__S_AXI_GP3 {1} CONFIG.PSU__USE__S_AXI_GP4 {1} CONFIG.PSU__USE__S_AXI_GP5 {1} CONFIG.PSU__USE__IRQ0 {0} CONFIG.PSU__CRL_APB__PL0_REF_CTRL__FREQMHZ {233}] [get_bd_cells zynq_ultra_ps_e_0]


set_property  ip_repo_paths  ./HLS_ultra96 [current_project]
update_ip_catalog
...
make_wrapper -files [get_files ./RTL_ultra96/RTL_ultra96.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse ./RTL_ultra96/RTL_ultra96.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v

...
void wino_systolic_kernel(    WEIGHT_PORTS_DECLARE(weight_DDR),
	...
	ap_uint<OUT_WIDTH*2> out_buffer0_2_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*2> out_buffer0_3_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	...
	ap_uint<OUT_WIDTH*2> out_buffer1_2_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*2> out_buffer1_3_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	...
	ap_uint<OUT_WIDTH*2> out_buffer2_2_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*2> out_buffer2_3_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	...
	ap_uint<OUT_WIDTH*2> out_buffer3_2_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],
	ap_uint<OUT_WIDTH*2> out_buffer3_3_0[WINO_H2][WINO_W2][WINO_OUT_SIZE_CELL][OUTPUT_BUFFER_DEPTH],

...
class ConvDesc_t():
    ...
    def gen_conv_desc(self):
        ...
        elif(input_buffer_row_capacity >= input_height ):
    ...
    for i in range( conv_desc.output_height):
        for j in range( conv_desc.output_width):
            for k in range( conv_desc.output_depth//8):
                print(i,j,l, output_FM[ (i*conv_desc.output_depth/8+k*conv_desc.output_width+j)*8:(i*conv_desc.output_depth/8+k*conv_desc.output_width+j)*8+8 ])        
